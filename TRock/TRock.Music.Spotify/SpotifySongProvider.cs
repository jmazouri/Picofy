...
namespace TRock.Music.Spotify
{
    public class SpotifySongProvider : ISongProvider
    {
        ...
        public Task<Song> GetSongFromUri(string uri, CancellationToken cancellationToken)
        {
            return _client
                .GetAsync(new Uri("http://ws.spotify.com/lookup/1/.json?uri=" + uri), cancellationToken)
